<template>
  <div>
    <PageHeader title="三轴一体化（时间轴·损害树·对策集）" desc="以进水险情为背景，构建险情时间轴（进水发生→渗漏扩散→舱室漫水→姿态失稳→极限工况触发）、故障损害树（险情根源、连锁故障、次生风险传导路径）与对策集（堵漏、压载调控、姿态校正、高压气抗沉、动力抗沉），形成时序化、可视化动态决策体系" />
